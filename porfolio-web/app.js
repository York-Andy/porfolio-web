...
function enviarFormulario() {
    ...
    if (nombre === '' || correo === '' || mensaje === '') {
        ...
        // Aquí podrías hacer una llamada a tu script de PHP que envía el correo
        // mediante AJAX o recargar la página con los datos del formulario.
...
// Asegúrate de agregar esta función al botón de envío en el HTML
// <input type="submit" value="Enviar" class="btn" onclick="return enviarFormulario();">
